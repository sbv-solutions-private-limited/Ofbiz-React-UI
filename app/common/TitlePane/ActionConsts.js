...
export const ACTION_TYPE_UPDATE_BUDGET_STATUS = 'updateBudgetStatus';
export const ACTION_TYPE_SAVE_ITEM = 'saveItem';
export const ACTION_TYPE_ITEM_DELETE = 'removeItem';
export const ACTION_TYPE_SAVE_ROLES = 'saveRole';
export const ACTION_TYPE_ROLE_DELETE = 'removeRole';
export const ACTION_TYPE_SAVE_Reviews = 'saveReviews';
export const ACTION_TYPE_REMOVE_Reviews = 'removeReviews';
export const ACTION_TYPE_UPDATE_FIXEDASSET = 'updateFixedAsset';
export const ACTION_TYPE_SAVE_FA_PROD = 'saveFAprod';
export const ACTION_TYPE_UPDATE_FA_PROD = 'updateFAprod';
export const ACTION_TYPE_REMOVE_FAprod = 'removeFAprod';
export const ACTION_TYPE_ADD_FA_SC = 'addFASC';
export const ACTION_TYPE_UPDATE_FA_SC = 'updateFASC';
export const ACTION_TYPE_REMOVE_FASC = 'removeFASC';
export const ACTION_TYPE_ADD_IDEN = 'addIDEN';
export const ACTION_TYPE_UPDATE_IDEN = 'updateIDEN';
export const ACTION_TYPE_REMOVE_IDEN = 'removeIDEN';
export const ACTION_TYPE_ADD_REG = 'addReg';
export const ACTION_TYPE_UPDATE_REG = 'updateReg';
export const ACTION_TYPE_REMOVE_REG = 'removeReg';
export const ACTION_TYPE_ADD_MR = 'addMR';
export const ACTION_TYPE_UPDATE_MR = 'updateMR';
export const ACTION_TYPE_REMOVE_MR = 'removeMR';
export const ACTION_TYPE_ADD_MAIN = 'addMAINT';
export const ACTION_TYPE_REMOVE_MAINT = 'removeMAINT';
export const ACTION_TYPE_ADD_ASSIGN = 'addAssign'; 
export const ACTION_TYPE_UPDATE_ASSIGN = 'updateAssign'; 
export const ACTION_TYPE_REMOVE_ASSIGN = 'removeAssign'; 
export const ACTION_TYPE_SAVE_DEP_METHOD = 'saveDEP';
export const ACTION_TYPE_SAVE_GL_MAP = 'saveGLMAP';
export const ACTION_TYPE_REMOVE_DEP_METHOD = 'removeDEP';
export const ACTION_TYPE_REMOVE_REMOVE_GL = 'removeGL';
export const ACTION_TYPE_UPDATE_MAINT = 'updateMAINT';
export const ACTION_TYPE_SAVE_MO = 'saveMO';
export const ACTION_TYPE_REMOVE_MO = 'removeMO';
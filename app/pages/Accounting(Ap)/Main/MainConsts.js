//defined Form Field Labels,page title,namespace,tab etc constants name 

export const PAGE_TITLE = 'Main';
export const PAGE_TITLE_TAGLINE = 'Main AP details - for OFBiz';
...
export const TAB1_CAPTION = 'Past Due Invoices';
export const TAB2_CAPTION = 'Invoices Due Soon';

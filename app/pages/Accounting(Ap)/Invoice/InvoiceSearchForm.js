    ...
    return (
      <Fragment>
        <Tabs defaultActiveKey="1" onChange={this.callback}>
          ...
          <TabPane tab="Purchase Invoices" key="2">
            <Row gutter={20} style={{ marginTop: '15px' }}>
              <Col span={6}>
                <FormItem label={localConsts.VendorParty_LABEL}>
                  {getFieldDecorator('VendorParty', {})(
                    <Input
                      addonAfter={
                        <Icon onClick={this.showDrawer} type="idcard" />
                      }
              ...
              <Col span={6}>
                <FormItem label={localConsts.FromInvoiceDate_LABEL}>
                  {getFieldDecorator('from_Date', {})(
                    <DatePicker
                      onChange={this.onChange}
                      style={{ width: '250px' }}
            ...
            <Row gutter={20}>
              <Col span={6}>
                <FormItem label={localConsts.ThroughInvoiceDate_LABEL}>
                  {getFieldDecorator('from_Date', {})(
                    <DatePicker
                      onChange={this.onChange}
                      style={{ width: '250px' }}
              ...
              <Col span={6}>
                <FormItem label={localConsts.FromDueDate_LABEL}>
                  {getFieldDecorator('To_Date', {})(
                    <DatePicker
                      onChange={this.onChange}
                      style={{ width: '250px' }}
              ...
              <Col span={6}>
                <FormItem label={localConsts.ThroughDueDate_LABEL}>
                  {getFieldDecorator('To_Date', {})(
                    <DatePicker
                      onChange={this.onChange}
                      style={{ width: '250px' }}

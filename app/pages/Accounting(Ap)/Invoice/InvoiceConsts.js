// Page Configs
export const NAMESPACE = 'Invoice_AP';

export const PAGE_TITLE = 'Invoice';
export const PAGE_TITLE_TAGLINE = 'Invoice AP details - for OFBiz';
...
export const InvoiceTypeConst = [
  ...
  { value: 'CUST_RTN_INVOICE', label: 'Customer Return' },

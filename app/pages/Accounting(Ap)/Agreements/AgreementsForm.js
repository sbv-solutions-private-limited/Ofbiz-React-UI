  ...
  render() {
    ...
    const tableColumns2 = [
      ...
      },
      {
        ...
        dataIndex: 'AgreementItemTypeId',
        id: 'AgreementItemTypeId',
      },
      {
      ...
      },
      {
        ...
        dataIndex: 'AgreementText',
        id: 'AgreementText',
      },
      {
        title: `${localConsts.COLUMN_AgreementImage}`,
        dataIndex: 'AgreementImage',
        id: 'AgreementImage',
      },
      {
...
export default Form.create()(
  connect(({ Agreements_AP }) => ({
    Data: Agreements_AP.reducerSaveAgreement,
    AgreementTerm: Agreements_AP.reducerSaveAgreementTerm,
    AgreementItem: Agreements_AP.reducerSaveAgreementItem,
    AgreementWorkEffort: Agreements_AP.reducerSaveAgreementWorkEffort,
  }))(AgreementsForm),
);

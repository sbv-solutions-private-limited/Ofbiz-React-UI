...
class VendorsSearchForm extends React.PureComponent {
  constructor(props) {
    super(props);
    this.state = {
      ReceivedValues: [],
    ...
    return (
      <Fragment>
        <Row style={{ marginTop: '15px' }}>
          <Col span={7}>
            <FormItem label={localConsts.VendorID}>
...
VendorsSearchForm.propTypes = {
  form: PropTypes.any,
  handleSubmitAction: PropTypes.func,
  handleSearchFilters: PropTypes.func,
};
export default Form.create()(connect()(VendorsSearchForm));

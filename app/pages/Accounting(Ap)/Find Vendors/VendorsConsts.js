// Page Configs
export const NAMESPACE = 'Vendors_AP';

export const PAGE_TITLE = 'Vendors';
export const PAGE_TITLE_TAGLINE = 'Vendors AP details - for OFBiz';
export const FORM_ID = 'VendorsForm';
export const NOTIFICATION_TITLE = 'Vendors (List)';
...
export const COLUMN_Middleinitial = 'Middle initial';
...
export const ManifestCompanyName = 'Manifest Company Name';
export const ManifestCompanyTitle = 'Manifest Company Title';
...
export const ManifestLogoUrl = 'ManifestLogoUrl';
...
export const COLUMN_AccountingExternalAccountId =
  'Accounting External Account Id';
export const ManifestPolicies = ' Manifest Policies';
...
export const VendorID = 'Vendor Id';

...
import { Table, Button, Icon, Popconfirm, Input, Badge,Card } from 'antd';
...
class InvoiceTable extends Component {
  ...
  render() {
    ...
    return (
      <div>
       <Card title="Communications of party: [admin]" bordered={false} >
        <div >
          <Table
      ...
      <Card title="Draft Emails" bordered={false} >
  ...
  tableColumns = [
    {
      title: `${localConsts.COLUMN_Subject}`,
    ...
    {
      title: `${localConsts.COLUMN_CommTypeId}`,
      dataIndex: 'Invoice Type',
      width: 300,
      sorter: (a, b) => a.shortName.length - b.shortName.length,
    },
    {
      title: `${localConsts.COLUMN_PartyIdFrom}`,
      dataIndex: 'Invoice Date',
      width: 250,
    },
     {
      title: `${localConsts.COLUMN_PartyIdTo}`,
      dataIndex: 'ToParty',
      width: 250,
    },
    {
  ...
  tableColumns1 = [
    ...
    {
      title: `${localConsts.COLUMN_RoleStatusId}`,
      dataIndex: 'status',
      width: 250,
    },
    {
      title: `${localConsts.COLUMN_Sent}`,
      dataIndex: 'status',
      width: 250,
    },
    {
...
export default connect(({ Invoice_AR }) => ({
  data: Invoice_AR.reducerList.data || [],
}))(InvoiceTable);

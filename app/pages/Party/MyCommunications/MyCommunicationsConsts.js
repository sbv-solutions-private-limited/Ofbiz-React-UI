// Page Configs
export const NAMESPACE = 'MyCommunications';

export const PAGE_TITLE = 'My Communications';
export const PAGE_TITLE_TAGLINE = 'My Communications details - for OFBiz';
...
export const COLUMN_PartyIdTo = 'Party Id To';
export const COLUMN_PartyIdFrom ='Party Id From';
export const COLUMN_CommTypeId ='Comm Type Id';
export const COLUMN_Subject = 'Subject';
export const COLUMN_Sent ='Sent';
export const COLUMN_RoleStatusId ='Role Status Id';
...
export const TAB1_CAPTION = 'New Email';
export const TAB2_CAPTION = 'New Internal Note';
...
export const COLUMN_ContactMechId ='Contact Mech Id';
export const PartyTo_LABEL = 'Party To';
export const ExistingContentId_LABEL ='Existing Content Id';
export const ParentContentID_LABEL ='Parent Content ID';
export const COLUMN_ContentName ='Content Name';
export const FromEmailAddr_LABEL = 'From Email Add';
// export const ToPartyID_LABEL ='To Party ID';
export const SendDate_LABEL = 'Send Date';
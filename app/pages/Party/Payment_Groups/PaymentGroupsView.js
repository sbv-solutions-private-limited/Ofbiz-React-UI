...
import PaymentGroupsTable from './PaymentGroupsTable';
import PaymentGroupsForm from './PaymentGroupsForm';
import * as localConsts from './PaymentGroupsConsts';
import styles from '../../../common/Styles.less';

const { Content } = Layout;

class PaymentGroupsView extends React.PureComponent {
  constructor(props) {
    super(props);
    this.state = {
...
export default Form.create()(
  connect(({ Payment_Groups_AR }) => ({ Payment_Groups_AR }))(PaymentGroupsView),
);

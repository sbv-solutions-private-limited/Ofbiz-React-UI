...
import { Table, Button, Icon, Popconfirm, Input, Badge,Tabs } from 'antd';
...
class ReportsTable extends Component {
  ...
  render() {
    ...
    return (
      <div>
        <div >
        <Tabs style={{marginTop:'0px'}} defaultActiveKey="Past Due Invoices" onChange={this.callback}>
...
export default connect(({ Reports_AR }) => ({
  data: Reports_AR.reducerList.data || [],
}))(ReportsTable);

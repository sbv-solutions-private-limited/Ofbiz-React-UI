...
export default Form.create()(
  connect(({ Invoice_AR }) => ({
    dataById: [],
    data: Invoice_AR.reducerSave,
    InvoiceItem: Invoice_AR.reducerSaveInvoiceItem,
    InvoiceRole: Invoice_AR.reducerSaveInvoiceRole,
    InvoiceTerm: Invoice_AR.reducerSaveInvoiceTerm,
  }))(InvoiceForm),
);

...
export const NAMESPACE = 'FinancialAccount';

export const PAGE_TITLE = 'Financial Account';
export const PAGE_TITLE_TAGLINE = 'Financial Account details - for OFBiz';
export const FORM_ID = 'FinancialAccountForm';
export const NOTIFICATION_TITLE = 'Financial Account (List)';
export const FinAccountId	 = 'Fin Account Id	'; 
export const FinAccountType = 'Fin Account Type';
export const Status = 'Status';
export const PaymentGroupId	 = 'Payment Group Id	';
export const StatusID = 'Status Id';
export const FinAccountName = 'Fin Account Name	';	 
export const FinAccountCode	 = 'Fin Account Code	';
export const FinAccountPin	 = 'Fin Account Pin	';
export const PaymentGroupType	 = 'Payment Group Type';
export const Currency = 'Currency';
export const PaymentGroupName = 'PaymentGroupName';
export const OrganizationPartyId	 = 'Organization Party Id	';
export const OwnerPartyId	 = 'Owner Party Id';
export const PostToGlAccountId	 = 'Post To Gl Account Id	';
export const FromDate = 'From Date';
export const ReconciledDate= 'Reconciled Date';
export const CancelBankReconciliation= 'CancelBankReconciliation';	 
export const ReconciledBalance	 = 'Reconciled Balance	';
export const ThroughDate	 = 'Through Date';
export const IsRefundable = 'Is Refundable	';	
export const ReplenishPaymentId	= 'Replenish Payment Id	';
export const ReplenishLevel	 = 'Replenish Level	';
export const ActualBalance	= 'Actual Balance	';
export const AvailableBalance	= 'Available Balance	';
export const ReplenishLevelFrom = 'Replenish Level From';
export const ReplenishLevelTo= 'Replenish Level To';
export const ActualBalanceFrom	= 'Actual Balance from	';
export const ActualBalanceTO	= 'Actual Balance	to';
export const AvailableBalanceFrom	= 'Available Balance from	';
export const AvailableBalanceTo	= 'Available Balance	to';
export const GLAccountID= 'GL Account ID';
export const GLAccountClass	 = 'GL Account Class	';
export const ActualCurrencyAmount	 = 'Actual Currency Amount';
export const  ActualCurrencyUomId	= 'Actual Currency Uom Id	';
export const Name	 = 'Name';
export const FinAccountTransId	= 'Fin Account Trans Id	';
export const FinAccountTransTypeId	 = 'Fin Account Trans Type Id	';
export const Party = 'Party';
export const  GlReconciliationName	= 'Gl Reconciliation Name	';
export const TransactionDate	= 'Transaction Date	';
export const EntryDate	 = 'Entry Date	';
export const PaymentId	= 'Payment Id	';
export const PaymentType	 = 'Payment Type	';
export const Comments	= 'Comments	';
export const Cancel='Cancel';
export const TransactionStatus = 'Transaction Status';
export const GlReconciliationId = 'Gl Reconciliation Id';
export const FromTransactionDate = 'From Transaction Date';
export const ThruTransactionDate	 = 'Thru Transaction Date	';
export const FromEntryDate	= 'From Entry Date	';
export const ThruEntryDate	= 'Thru Entry Date	';
export const PartyId = 'Party Id';
export const OrderItemSeqId= 'Order Item Seq Id';
export const ReasonEnumId	 = 'Reason Enum Id	';
export const GLAccount	 = 'GL Account	';
...
export const OverrideGlAccountId='Override Gl Account Id';
export const FinAccountAuthId	 = 'Fin Account Auth Id	';
export const AuthorizationDate='Authorization Date';

export const ItemNo = 'Item No';
export const Amount = 'Amount';
export const OrderId = 'Order Id';
export const OrderDate = 'Order Date';
export const PaymentMethodId_LABEL = 'Payment Method Type';
export const paymentType_LABEL = 'payment Type';
export const PaymentMethodType = 'Payment Method Type	';
export const AmountApplied = 'Amount Applied	';
...
export const partyIdTo = 'party Id To';
...
export const ReconciliationDate = 'Reconciliation Date';
export const OpeningBalance = 'Opening Balance';
export const LastModifiedDate = 'Last Modified Date';
...
export const from_Date = [
  ...
  { value: 'greaterThanEqualTo', label: 'Greater Than Equals' },
];
...
export const To_Date = [
  ...
  { value: 'lessThanEqualTo', label: 'Less Than Equals' },
...
export const Roles_title = 'Financial Account Roles';
...
export const TermTypeId_LABEL = 'Term Type';
...
export const AccountCurrencyUomId = 'Account Currency Uom Id';
export const ContactMechId = 'ContactMechId';
export const AccountLimit = 'Account Limit';
...
export const AccountingExternalAccountId_LABEL =
  'External Account Id';
export const PartyBilledTo = 'Party Billed To';
...
export const NewTerms_title = 'Edit Terms';
...
export const NewProduct_title = 'Lookup GL Account';
...
export const TAB2_CAPTION = 'Create Financial Account';
...
export const TermTypeDropDown = [
  { value: 'FIN_LATE_FEE_TERM', label: 'Late Fee (percent)' },
  { value: 'FIN_NORTN_ITEM_TERM', label: 'Non-Returnable Sales Item' },
  { value: 'FIN_PAYMENT_DISC', label: 'Payment (discounted if paid within specified days)' },
  { value: 'FIN_PAYMENT_FIXDAY', label: 'Payment (due on specified day of month)' },
  { value: 'FIN_PAYMENT_TERM', label: 'Payment (net days)' },
  { value: 'FIN_COLLECT_TERM', label: 'Penalty For Collection Agency' }
];

...
export const PAGE_TITLE_TAGLINE = 'Transactions Accounting details - for OFBiz';
export const FORM_ID = 'TransactionsForm';
export const NOTIFICATION_TITLE = 'Transactions (List)';
...
export const TAB1_CAPTION = 'View Gateway Response';
export const TAB2_CAPTION = 'Authorize';
export const TAB3_CAPTION = 'Capture';
export const TAB4_CAPTION = 'Manual Electronic Transaction';
...
export const PaymentGatewayResponseId = 'Payment Gateway Response Id';
export const PaymenServiceTypeEnumId = 'Payment Service Type Enum Id ';
export const OrderPaymentPreferenceId = 'Order Payment Preference Id ';
export const PaymentMethodType = 'Payment Method Type ';
export const PaymentMethodId = 'Payment Method Id ';
export const TransCodeEnumId = 'Trans Code Enum Id';
export const AmountCurrency = 'Amount 	Currency';
export const ReferenceNum = 'Reference Num';
export const AltReference = 'Alt Reference ';
export const SubReference = 'Sub Reference ';
export const GatewayCode = 'Gateway Code ';
export const GatewayFlag = 'Gateway Flag ';
export const GatewayAvsResult = 'Gateway Avs Result';
export const GatewayCvResult = 'Gateway Cv Result ';
export const GatewayScoreResult = 'Gateway Score Result ';
export const GatewayMessage = 'Gateway Message ';
export const TransactionDate = 'Transaction Date ';
export const ResultDeclined = ' Result Declined ';
export const ResultNsf = ' Result Nsf ';
export const ResultBadExpire = ' Result Bad Expire ';
export const ResultBadCardNumber = ' Result Bad Card Number ';
export const AccountingPaymentGatewayResponseId =
  'Accounting Payment Gateway Response Id';
export const AccountingOrderPaymentPreferenceId =
  'Accounting Order Payment Preference Id ';
...
export const PaymentMethodTypeIdDropDown = [
  { value: 'CREDIT_CARD', label: 'CREDIT CARD' },
];
export const ProductStoreDropDown = [
  { value: '9000', label: 'OFBiz E-Commerce Store' },
  { value: '9100', label: 'OFBiz Physical Retail Store' },
  { value: 'RentalStore', label: 'Open Travel system Demo Site' },
];
export const TransactionTypeDropDown = [
  { value: 'Select one', label: 'Select One' },
  { value: 'PRDS_PAY_AUTH', label: 'Payment Authorization Service' },
  { value: 'PRDS_PAY_REAUTH', label: 'Payment Re-Authorization Service' },
  { value: 'PRDS_PAY_RELEASE', label: 'Payment Release Authorization Service' },
  { value: 'PRDS_PAY_CAPTURE', label: 'Payment Capture Service' },
  { value: 'PRDS_PAY_REFUND', label: 'Payment Refund Service' },
  { value: 'PRDS_PAY_AUTH_VERIFY', label: 'Payment Auth Verification Service' },
  { value: 'PRDS_PAY_CREDIT', label: 'Payment Credit Service' },
  { value: 'PRDS_PAY_EXTERNAL', label: 'External Payment (No Service)' },
];
export const EMailAddress = 'E-Mail Address';
export const CompanyNameCard = 'Company Name Card';
export const PrefixCard = 'Prefix Card';
export const SuffixonCard = 'Suffix on Card';
export const PrefixCardDropDown = [
...
export const FirstNameCard = 'First Name Card';
export const MiddleNameCard = 'Middle Name Card';
export const LastNameCard = 'Last Name Card';
export const SuffixonCardDropDown = [
  { value: '', label: 'Select One' },
  { value: '', label: 'Jr.' },
  { value: '', label: 'I' },
  { value: '', label: 'II' },
...
export const CardTypeDropDown = [
  { value: 'CCT_VISA', label: 'Visa' },
  { value: 'CCT_MASTERCARD', label: 'MasterCard' },
  { value: 'CCT_AMERICANEXPRESS', label: 'AmericanExpress' },
  { value: 'CCT_DINERSCLUB', label: 'DinersClub' },
  { value: 'CCT_DISCOVER', label: 'Discover' },
  { value: 'CCT_ENROUTE', label: 'EnRoute' },
  { value: 'CCT_CARTEBLANCHE', label: 'CarteBlanche' },
  { value: 'CCT_SOLO', label: 'Solo' },
  { value: 'CCT_SWITCH', label: 'Switch' },
];
export const PaymentMethodTypeDropDown = [
  { value: 'EXT_IDEAL', label: 'iDEAL' },
  { value: 'CREDIT_CARD', label: 'Credit Card' },
  { value: 'GIFT_CARD', label: 'Gift Card' },
  { value: 'GIFT_CERTIFICATE', label: 'Gift Certificate' },
  { value: 'CASH', label: 'Cash' },
  { value: 'EFT_ACCOUNT', label: 'Electronic Funds Transfer' },
  { value: 'FIN_ACCOUNT', label: 'Financial Account' },
  { value: 'PERSONAL_CHECK', label: 'Personal Check' },
  { value: 'COMPANY_CHECK', label: 'Company Check' },
  { value: 'CERTIFIED_CHECK', label: 'Certified Check' },
  { value: 'MONEY_ORDER', label: 'Money Order' },
  { value: 'COMPANY_ACCOUNT', label: 'Company Account' },
  { value: 'EXT_BILLACT', label: 'Billing Account' },
  { value: 'EXT_COD', label: 'Cash On Delivery' },
  { value: 'EXT_EBAY', label: 'eBay' },
  { value: 'EXT_OFFLINE', label: 'PayPal' },
  { value: 'EXT_PAYPAL', label: 'Cash On Delivery' },
  { value: 'EXT_WORLDPAY', label: 'RBS WorldPay' },
];
...
export const BillToAddress1 = 'Bill-To ddress1';
export const BillToAddress2 = 'Bill-To ddress2';
export const City = 'City';
export const State_Province = 'State/Province';
export const Zip_PostalCode = 'Zip/PostalCode';

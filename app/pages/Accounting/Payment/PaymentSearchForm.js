    ...
    return (
      <Fragment>
        <Tabs defaultActiveKey="1" onChange={this.callback}>
          <TabPane tab="Find Payments" key="1">
          ...
          <TabPane tab="Find Sales Invoices By Due Date" key="2">
            <Row gutter={20} style={{ marginTop: '15px' }}>
              <Col span={7}>
            ...
            <Row gutter={20}>
              <Col span={7}>
                <FormItem label={localConsts.DaysOffset}>
                  {getFieldDecorator('DaysOffset', {})(
                    <Input
                      //   dataSource={this.state.dataSource}
                      style={{ width: 295 }}
                      //   onChange={this.handleChange}
          ...
          <TabPane tab="Find Purchase Invoices By Due Date" key="">
            <Row gutter={20} style={{ marginTop: '15px' }}>
              <Col span={7}>
                <FormItem label={localConsts.OrganizationPartyId}>
                  {getFieldDecorator('FromPartyID', {})(

...
class AgreementsSearchForm extends React.PureComponent {
  constructor(props) {
    super(props);
    this.state = {
      ReceivedValues: [],
          ...
          <Col span={6} offset={1}>
            <FormItem label={localConsts.ProductId_LABEL}>
              {getFieldDecorator('ProductId')(
                <Input
                  addonAfter={<Icon onClick={this.showDrawer1} type="idcard" />}
                />,
              )}
            </FormItem>
          </Col>
...
AgreementsSearchForm.propTypes = {
  form: PropTypes.any,
  handleSubmitAction: PropTypes.func,
  handleSearchFilters: PropTypes.func,
};

export default Form.create()(connect()(AgreementsSearchForm));

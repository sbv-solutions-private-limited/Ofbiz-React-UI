...
export default Form.create()(
  connect(({ Agreements_Accounting }) => ({
    Data: Agreements_Accounting.reducerSaveAgreement,
    AgreementTerm: Agreements_Accounting.reducerSaveAgreementTerm,
    AgreementItem: Agreements_Accounting.reducerSaveAgreementItem,
    AgreementWorkEffort: Agreements_Accounting.reducerSaveAgreementWorkEffort,
  }))(AgreementsForm),
);

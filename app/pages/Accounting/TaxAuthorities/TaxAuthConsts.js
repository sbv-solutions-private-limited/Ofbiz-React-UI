export const NAMESPACE = 'Tax_Auth_Accounting';
export const PAGE_TITLE = 'Tax Authorities';
export const PAGE_TITLE_TAGLINE = 'Tax Authorities Accounting details - for OFBiz';
export const FORM_ID = 'TaxAuthoritiesForm';
export const NOTIFICATION_TITLE = 'Tax Authorities (List)';
export const TaxAuthGeoID = 'TaxAuthGeoID';
export const TaxAuthorityParty	 = 'Tax Authority Party	';
export const RequireTaxIdForExemption	 = 'Require Tax Id For Exemption	';
export const TaxIdFormatPattern	 = 'Tax Id Format Pattern	';
export const IncludeTaxInPrice	 = 'Include Tax In Price	';
export const Party = 'Party';
export const Geo = 'Geo';
export const GeoID	 = 'Geo ID';
export const  GeoTypeID	 = 'Geo Type ID	';
export const Name = 'Name';
export const Code = 'Code';
export const SecondaryCode	= 'Secondary Code	';
export const Abbreviation = 'Abbreviation';
export const WellKnownText = 'Well Known Text';
export const Category = 'Category';
export const TitleTransfer = 'Title Transfer';
export const CategoryID	= 'Category ID';
export const ProductCategoryId = 'ProductCategoryId';
export const CategoryName	 = 'Category Name	';
export const ProductCategoryTypeId = 'Product Category Type Id';
export const PrimaryParentCategoryId	 = 'Primary Parent Category Id';
export const LongDescription	 = 'Long Description	';
export const ShowInSelect = 'Show In Select';
export const CategoryImageUrl	 = 'Category Image Url	';
export const LinkOneImageUrl	 = 'Link One Image Url	';
export const LinkTwoImageUrl	= 'Link Two Image Url	';
export const DetailScreen	= 'Detail Screen	';
export const ToTaxAuthGeoId = 'To Tax Auth Geo Id';
export const ToTaxAuthPartyId	= 'To Tax Auth Party Id	';
export const Type = 'Type';
export const MinItemPrice	 = 'Min Item Price	';
export const MinPurchase	= 'Min Purchase	';
export const TaxShipping	 = 'Tax Shipping	';
export const TaxPercentage	= 'Tax Percentage	';
export const TaxPromotions	 = 'Tax Promotions	';
export const IsTaxInShippingPrice	 = 'Is Tax In Shipping Price	';
export const PayToPartyId = 'Pay To Party Id';
export const CompanyName = 'Company Name';
export const StoreName = 'Store Name';
export const ProductStoreId = 'Product Store Id';
export const PrimaryStoreGroupId	 ='Primary Store Group Id	';
export const PartyTaxId = 'Party Tax Id';
export const IsExempt ='Is Exempt';	 
export const IsNexus	 = 'Is Nexus	';
...
export const taxAuthorityRateSeqId = 'taxAuthorityRateSeqId';
...
export const OrganizationParty = 'Organization Party';

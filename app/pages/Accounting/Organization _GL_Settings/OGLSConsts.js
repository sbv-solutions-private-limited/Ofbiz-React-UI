...
export const NAMESPACE = 'OGLS_Accounting';

export const PAGE_TITLE = 'Organization GL Settings';
export const PAGE_TITLE_TAGLINE = 'Available Internal Accounting Organizations';
export const FORM_ID = 'OGLSForm';
export const NOTIFICATION_TITLE = 'Organization GL Settings (List)';
...
export const TAB1_CAPTION = 'Setup';
export const TAB2_CAPTION = 'Create new accounting company';
export const TAB3_CAPTION = 'Accounting';
...
export const FiscalYearStartMonth = 'Fiscal Year Start Month';
export const FiscalYearStartDay = 'Fiscal Year Start Day	';
export const TaxFormforOrganization = 'Tax Form for Organization	';

export const Code = 'Code';
export const AccountName = 'Account Name';
export const ParentGlAccountId = 'Parent Gl Account Id	';
export const GlAccountTypeId = 'Gl Account Type Id	';
export const GlAccountClassId = 'Gl Account Class Id	';
export const GlResourceTypeId = 'Gl Resource Type Id	';
export const GlXbrlClassId = 'Gl Xbrl Class Id	';

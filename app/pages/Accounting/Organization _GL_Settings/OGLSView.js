...
import AgreementsTable from './OGLSTable';
import AgreementsForm from './OGLSForm';
import * as localConsts from './OGLSConsts';
import styles from '../../../common/Styles.less';

const { Content } = Layout;

class OGLSView extends React.PureComponent {
  constructor(props) {
    super(props);
    this.state = {
...
export default Form.create()(
  connect(({ OGLS_Accounting }) => ({ OGLS_Accounting }))(OGLSView),
);

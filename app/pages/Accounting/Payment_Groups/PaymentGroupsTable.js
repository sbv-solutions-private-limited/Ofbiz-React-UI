...
class PaymentGroupsTable extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (nextProps.paymentGroup != undefined) {
      ...
      this.setState({ paymentGroup: tmp });
    }
  }
  componentDidMount() {
      ...
      <div>
        <div className={styles.tableContainerParent}>
          <Table
            ...
            dataSource={this.state.paymentGroup}
            size="small"
      ...
      render: data => (
        <div>
          ...
          <Popconfirm
            ...
            onConfirm={() =>
              this.props.handleSubmitAction(
                actionConsts.ACTION_TYPE_PAYMENT_GROUP_DELETE,
                data,
              )
            }
          >
...
export default connect(({ Payment_Groups_Accounting }) => ({
  data: [],
  paymentGroup: Payment_Groups_Accounting.reducerSave,
}))(PaymentGroupsTable);

...
export const NAMESPACE = 'BillingAccount';

export const PAGE_TITLE = 'Billing Account';
export const PAGE_TITLE_TAGLINE = 'Billing Accounting details - for OFBiz';
export const FORM_ID = 'BillingAccountForm';
export const NOTIFICATION_TITLE = 'Billing Account (List)';
...
export const billingRoles_title = 'Billing Account Roles';
...
export const TAB2_CAPTION = 'Create Billing Account';

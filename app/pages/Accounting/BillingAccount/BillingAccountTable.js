...
import BillingAccountSearchForm from './BillingAccountSearchForm';
...
class BillingAccountTable extends Component {
  constructor(props) {
    super(props);
    this.state = {
      selectedRowKeys: [],
  ...
  componentWillReceiveProps(nextProps) {
    if (nextProps.data != undefined) {
      var tmp = [];
      tmp.push({ billingAccountId: nextProps.data.billingAccountId });
  ...
  tableColumns = [
    {
      title: `${localConsts.BillingAcctID_LABEL}`,
    ...
    {
      title: `${localConsts.AccountLimit}`,
  ...
  tableHeader = () => (
    <div>
      <TableOptions
        ...
        searchForm={BillingAccountSearchForm}
      />
    </div>
  );
...
export default connect(({ BillingAccount }) => ({

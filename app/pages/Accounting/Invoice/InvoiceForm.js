            ...
            >
              ...
              >
                <RadioGroup onChange={this.onChange} value={this.state.value}>
                  <Radio value={1}>New Sales Invoice</Radio>
                  <Radio value={2}>New Purchase Invoice</Radio>
                </RadioGroup>
                {this.state.value === 1 && (
                  <div>
                    {' '}
                    <Row style={{ marginTop: '15px' }}>
                      <Col span={7}>
                        <FormItem label={localConsts.OrganizationPartyId_LABEL}>
...
export default Form.create()(
  connect(({ Invoice_Accounting }) => ({
    dataById: [],
    data: Invoice_Accounting.reducerSave,
    InvoiceItem: Invoice_Accounting.reducerSaveInvoiceItem,
    InvoiceRole: Invoice_Accounting.reducerSaveInvoiceRole,
    InvoiceTerm: Invoice_Accounting.reducerSaveInvoiceTerm,
  }))(InvoiceForm),
);

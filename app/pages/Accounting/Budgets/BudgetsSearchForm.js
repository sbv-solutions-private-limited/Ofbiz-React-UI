...
class BudgetsSearchForm extends React.PureComponent {
  constructor(props) {
    super(props);
    this.state = {
      ReceivedValues: [],
    ...
    return (
      <Fragment>
        <Tabs defaultActiveKey="1" onChange={this.callback}>
          <TabPane tab="Find Budgets" key="1">
            ...
            <Col span={7}>
              ...
              <Col span={6}>
                <FormItem label={localConsts.BudgetType}>
...
BudgetsSearchForm.propTypes = {
  form: PropTypes.any,
  handleSubmitAction: PropTypes.func,
  handleSearchFilters: PropTypes.func,
};
export default Form.create()(connect()(BudgetsSearchForm));

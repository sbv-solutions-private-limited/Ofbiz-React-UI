...
import { Table, Button, Icon, Input, Tabs, Badge } from 'antd';
import TableOptions from '../../../common/Table/TableOptions';
import PaymentGatewayConfigSearchForm from './PaymentGatewayConfigSearchForm';
...
class PaymentGatewayConfigTable extends Component {
  constructor(props) {
    super(props);
    this.state = {
      selectedRowKeys: [],
      ...
      <div>
        <div className={styles.tableContainerParent}>
          <Tabs defaultActiveKey="1">
            <TabPane tab="Payment Gateway Config" key="1">
              <Table
            ...
            <TabPane tab="Payment Gateway Config Types" key="2">
              <Table
                className={styles.tableContainer}
                rowKey="id"
                title={this.tableHeader}
  ...
  tableColumns = [
    {
      title: `${localConsts.PaymentGatewayConfigTypeId}`,
      dataIndex: 'PaymentGatewayConfigTypeId',
      // sorter: (a, b) => a.shortName.length - b.shortName.length,
    },
    {
      title: `${localConsts.PaymentGatewayConfigDescription}`,
      dataIndex: 'PaymentGatewayConfigDescription',
      // width: 150,
      // fixed: 'left',
  ...
  tableColumns1 = [
    {
      title: `${localConsts.ParentTypeId}`,
      dataIndex: 'ParentTypeId',
      sorter: (a, b) => a.shortName.length - b.shortName.length,
    },
    {
      title: `${localConsts.HasTable}`,
      dataIndex: 'HasTable',
      sorter: (a, b) => a.shortName.length - b.shortName.length,
    },
    {
      title: `${localConsts.PaymentGatewayConfigTypeDescription}`,
      dataIndex: 'PaymentGatewayConfigTypeId',
      key: 'PaymentGatewayConfigTypeId',
      // width: 150,
      sorter: (a, b) => a.name.length - b.name.length,
      filterDropdown: ({
        setSelectedKeys,
  ...
  tableHeader = () => (
    <div>
      <TableOptions
        ...
        searchForm={PaymentGatewayConfigSearchForm}
      />
    </div>
  );
...
PaymentGatewayConfigTable.propTypes = {
...
export default connect(({ PaymentGatewayConfig_Accounting }) => ({
  data: [],
  Payment: [],
}))(PaymentGatewayConfigTable);

...
import PaymentGatewayConfigTable from './PaymentGatewayConfigTable';
...
class PaymentGatewayConfigView extends React.PureComponent {
  constructor(props) {
    super(props);
    this.state = {
...
export default Form.create()(connect(({}) => ({}))(PaymentGatewayConfigView));

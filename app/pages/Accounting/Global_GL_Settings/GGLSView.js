...
import GGLSTable from './GGLSTable';
import GGLSForm from './GGLSForm';
import * as localConsts from './GGLSConsts';
import styles from '../../../common/Styles.less';
const { Content } = Layout;
class GGLSView extends React.PureComponent {
  constructor(props) {
    super(props);
    this.state = {
  ...
  handleSubmitAction = (actionType, dataForActionParam, nameSpaceParam) => {
    ...
    if (actionType === actionConsts.ACTION_TYPE_MULTIPLE_SELECTION) {
      ...
      console.log('data', dataForActionParam);
...
export default Form.create()(
  connect(({ GGLS_Accounting }) => ({ GGLS_Accounting }))(GGLSView),
);
